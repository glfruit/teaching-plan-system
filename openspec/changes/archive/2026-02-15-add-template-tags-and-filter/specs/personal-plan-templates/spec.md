...
#### Scenario: Save template with tags
- **WHEN** a teacher creates or updates a template with predefined and custom tags
- **THEN** the system SHALL persist the deduplicated tag array with the template
