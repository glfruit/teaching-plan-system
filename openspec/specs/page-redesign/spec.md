...
#### Scenario: Visible tab shortcut hint
- **WHEN** editor page renders tabbed navigation
- **THEN** UI SHALL display explicit shortcut hint for tab switching
- **AND** hint SHALL describe `Alt/Option + 1~4` mapping
